/**
 * BrowsePageAlert Component
 * User-facing message component for errors, success, and info messages
 */
...
/**
 * Alert Component
 * Displays user-facing messages with auto-dismiss
 */
export function BrowsePageAlert({ message, type = 'info', onDismiss, autoDismiss = true, duration = 5000 }) {
  ...
  const baseClasses =
    'flex items-center gap-3 px-4 py-3 rounded-lg border ' + TRANSITIONS.FADE;
...
export default BrowsePageAlert;
